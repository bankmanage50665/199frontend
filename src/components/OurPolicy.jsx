...
import { RefreshCw, Award, HeadphonesIcon, DollarSign } from "lucide-react";
  ...
  return (
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 py-16">
      <div className="container mx-auto px-6">
        <div className="flex flex-col sm:flex-row flex-wrap justify-around gap-12 sm:gap-2 text-center">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-gray-500 leading-relaxed">
              We offer hassle-free exchange for all our organic products
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-gray-500 leading-relaxed">
              Refunds are processed within 3–4 business days after returned
